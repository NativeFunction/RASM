...
{
private:
    Opcode* CommonOpsIndexedByTargetOps;
    bool IsLittleEndian;
...
#pragma region CTOR
    DecompileBase(Opcode commonOpsIndexedByTargetOps[255], GameTarget::GameTarget decompileTarget, uint32_t maxPageSize = 16384, bool isLittleEndian = false) :
        CommonOpsIndexedByTargetOps(commonOpsIndexedByTargetOps),
    ...
    DecompileBase(bool isLittleEndian = false)
    {
        SetEndian(isLittleEndian);
    }
#pragma endregion
...
public:
    DecompileGTAIV(GameTarget::GameTarget GameTarget) : DecompileBase(_CommonOpsIndexedByTargetOps, GameTarget, 16384, true)
    {
        Is64Bit = false;
        DecompileTarget = GameTarget::GTAIV;
        MaxPageSize = 16384;
        SetEndian(true);
...
public:
    DecompileRDR(GameTarget::GameTarget target) : DecompileBase(_CommonOpsIndexedByTargetOps, target)
    {
        Is64Bit = false;
        DecompileTarget = GameTarget::RDR;
        MaxPageSize = 16384;
        SetEndian(false);
        SetOps(_CommonOpsIndexedByTargetOps);
    }
