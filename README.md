...
PushString | Pushes a string pointer to the stack | ![pushstring](https://user-images.githubusercontent.com/27574733/184822773-70999817-c907-4cbf-ae87-b38824e03b8d.PNG)
GetHash | Loads a value off the stack, then returns a Jenkins hash of the value | ![gethash](https://user-images.githubusercontent.com/27574733/184822738-428310e4-9074-49a4-9098-30b9040e15b4.PNG)
...
ItoS | Loads a value and a dynamic destination string pointer off the stack, the destination string length off the code buffer, then converts the value into string and places it at the pointer | ![itos](https://user-images.githubusercontent.com/27574733/184822434-a0f17e88-6f03-489b-98fc-7305580d89eb.PNG)
...
StrAddi | Loads an integer and the destination string pointer off the stack, and the length from the code buffer, then adds the string representation of the integer onto the destination | ![straddi](https://user-images.githubusercontent.com/27574733/184822484-2cfbc1ff-78b3-4f36-96ad-d99ebbe9ae80.PNG)
